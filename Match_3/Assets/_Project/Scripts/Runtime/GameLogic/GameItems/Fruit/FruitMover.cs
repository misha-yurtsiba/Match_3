...
public class FruitMover
{
    ...
    {
        Tween tween = fruit.Transform
            .DOMove(position + _gameBoard.itemOffset + _fillingOffset, spead * 2);
        ...
        tween = fruit.Transform
            .DOMove(position + _gameBoard.itemOffset, spead * 2)
            .SetSpeedBased()
            .SetEase(Ease.Linear)
            .SetLink(fruit.Transform.gameObject)
            .OnKill(() => tween.Kill());
